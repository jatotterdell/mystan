...
namespace model_log_reg_namespace {
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_log_reg");
    reader.add_event(19, 17, "end", "model_log_reg");
    return reader;
}

#include <meta_header.hpp>
 class model_log_reg : public prob_grad {
private:
    int N;
    int K;
    vector<int> y;
    ...
    matrix_d X;
public:
    model_log_reg(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_log_reg_namespace::model_log_reg";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__,params_i__);
        static const char* function__ = "model_log_reg_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_log_reg_namespace::model_log_reg stan_model;
